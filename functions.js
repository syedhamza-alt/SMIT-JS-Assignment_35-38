...
document.write(
  ` The answer of desired operation is :  ${desiredOperation(10, 2, "*")}<br><br>`
);
...
function checkIfPalindrome(str) {
  ...
  if(string_10 == str){
    ...
    document.write(`The string ${string_10} is not a palindrome string <br><br>`);
  }
}
...
document.write(`After converting into TitleCase : ${toTitleCase(string_11)} <br><br>`);
...
document.write(
  `The longest word in '${string_12}' is : '${find_longest_word(string_12)}'.<br><br>`
);
...
function calcCircumference(radius) {
  ...
  return document.write( `The circumference of Cirle is : ${circumferenceCirc}<br>`);
}
